...
<img src="https://render.githubusercontent.com/render/math?math=\left\{0, 1\right\}">.

*Язык ассемблера* – формальный язык, алфавит которого состоит из цифр 
<img src="https://render.githubusercontent.com/render/math?math=\left\{0 - 9\right\}">, 
букв латинского алфавита <img src="https://render.githubusercontent.com/render/math?math=\left\{a - z, A-Z\right\}"> и других символов.
...
Наш пример содержит две *продукции (production)*, обозначенные цифрами *1* и 
*2*. Продукция состоит из двух частей:
...
<img src="https://render.githubusercontent.com/render/math?math=k"> – количество символов *предпросмотра (lookahead)* – число, обозначающее, 
...
Так как данной грамматике нужен только один символ предпросмотра, то <img src="https://render.githubusercontent.com/render/math?math=k = 1">. 
Иными словами, данная грамматика – либо <img src="https://render.githubusercontent.com/render/math?math=LL\left( 1 \right)">, либо <img src="https://render.githubusercontent.com/render/math?math=LR\left( 1 \right)">.

### Структура грамматик

Все грамматики имеют структуру дерева.

Если парсер использует <img src="https://render.githubusercontent.com/render/math?math=LL">-грамматику, то обход дерева начинается с корня и 
парсер двигается вниз по дереву (top-down parsing).

Если парсер использует <img src="https://render.githubusercontent.com/render/math?math=LR">-грамматику, то обход дерева осуществляется от 
